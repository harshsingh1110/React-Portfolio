    ...
    return (
        <div className="about_info grid">
            ...
            <i class="bx bx-award about_icon"></i>
                ...
                <span className="about_subtitle">1+ Year <svg width="0.8rem" height="0.8rem" viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" class="iconify iconify--noto" preserveAspectRatio="xMidYMid meet">
